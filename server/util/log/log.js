...
// 加载配置文件
var objConfig = JSON.parse(fs.readFileSync("./util/log/log4js.json", "utf8"));
...
var logLogin = log4js.getLogger('logLogin');
var logLogout = log4js.getLogger('logLogout');
var logChat = log4js.getLogger('logChat');
...
helper.writeLogin = function(msg) {
    if (!msg) {
        msg = "";
    }
    logLogin.info(msg);
...
helper.writeLogout = function(msg) {
    if (!msg) {
        msg = "";
    }
    logLogout.info(msg);
